package by.it.stebletsky.lesson06;
...
public class TaskC1 {
    public static void main(String[] args) {
        ...
        int i = sc.nextInt();
             ...
             Dog dog1 =   new Dog (sc.next(), sc.nextInt(), sc.nextInt(0), sc.nextDouble());
             Dog dog2 =   new Dog (sc.next(), sc.nextInt(), sc.nextInt(0), sc.nextDouble());
        if (dog1.win(dog2))
