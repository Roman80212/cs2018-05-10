...
class TaskA2 {
    public static void main(String[] args) {
        ...
        String d = "          Ў гаршку насення жменю там знайшлі.\n";
        String e = "          Хоць зернейкі засохшымі былі,\n";
        String f = "          Ўсё ж такі жыццёвая іх сіла\n";
        String g = "          Збудзілася і буйна ўскаласіла\n";
        String h = "          Парой вясновай збожжа на раллі.\n";
